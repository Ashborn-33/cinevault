...
export function AddToCollectionModal({
  ...
  return (
    <div className="fixed inset-0 z-modal flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-sm p-6 border border-border bg-surface rounded-card shadow-level-3 font-sans text-foreground animate-in fade-in zoom-in-95 duration-standard">
        {/* Close Button */}
        <button
          onClick={onClose}
