...
export function EditProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-modal flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-lg p-6 border border-border bg-surface rounded-card shadow-level-3 font-sans text-foreground max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-standard">
        {/* Close Button */}
        <button
          onClick={onClose}
